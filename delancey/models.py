...
# db = SqliteDatabase("delancey.db")
db = SqliteQueueDatabase("delancey.db", autostart=True)
...
class Post(BaseModel):
    ...
    book_author = TextField(null=True)
    book_title = TextField(null=True)
    book_pages = TextField(null=True)
    book_publisher = TextField(null=True)
    book_date = TextField(null=True)
